...
const PoliticaDadosPage = ({ data }) => {
  ...
  return (
    <Layout>
      ...
      <SiteMetadata title="Carta aberta política dados individual" description="Grupo de estudantes ambientalista do Instituto Superior Técnico." />
        ...
        <div className="container">
          <div className="flex justify-center flex-wrap">
            <div className="max-w-2xl pb-8">
              ...
              <h1 className="text-center text-2xl leading-tight font-extrabold tracking-tight text-gray-800 sm:text-2xl pb-1">Política de Privacidade e Proteção de Dados</h1>
              <h2 className="text-center text-xl leading-tight font-extrabold tracking-tight text-gray-800 sm:text-xl pb-5">Carta Aberta do Ensino Superior pelo Clima (para pessoas singulares)</h2>
