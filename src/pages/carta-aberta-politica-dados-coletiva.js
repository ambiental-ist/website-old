...
const PoliticaDadosPage = ({ data }) => {
  ...
  return (
    <Layout>
      ...
      <SiteMetadata title="Carta aberta política dados coletiva" description="Grupo de estudantes ambientalista do Instituto Superior Técnico." />
        ...
        <div className="container">
          <div className="flex justify-center flex-wrap">
            <div className="max-w-2xl pb-8">
              ...
              <h2 className="text-center text-xl leading-tight font-extrabold tracking-tight text-gray-800 sm:text-xl pb-5">Carta Aberta do Ensino Superior pelo Clima (para organizações)</h2>
