    ...
    <div className="container py-12 lg:py-16">
      ...
      <form className="mt-8 sm:flex" onSubmit={handleSubmit}>
        <input
          ...
          className="appearance-none w-full sm:max-w-xs px-5 py-3 border border-gray-400 leading-snug rounded-md text-gray-800 bg-white placeholder-gray-600 focus:outline-none focus:shadow-outline focus:border-blue-300 transition duration-150 ease-in-out"
